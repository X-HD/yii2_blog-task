            ...
            <div class="col-xs-10 text-right menu-1">
                <ul>
                    ...
                    <li class="has-dropdown">
                        <a href="<?= \yii\helpers\Url::toRoute(['site/category','id'=>$category->article->id])?>">Category</a>
                        <ul class="dropdown">
                            <?php foreach ($categories as $category):?>
                                <li><a href="<?= \yii\helpers\Url::toRoute(['site/category','id'=>$article->category->id]);?>"><?= $category->title?></a></li>
                            <?php endforeach;?>
                        </ul>
                    </li>
